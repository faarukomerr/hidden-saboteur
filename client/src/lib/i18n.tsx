...
export const translations: Translations = {
    ...
    rulesText1: { en: '1 Narrator, 1 Saboteur, everyone else guesses. Saboteur sees the word and sets traps!', tr: '1 Anlatıcı, 1 Sabotajcı, geri kalan herkes tahmin eder. Sabotajcı kelimeyi görür ve tuzak kurar!' },
    rulesText2: { en: 'Narrator picks 1-2 mins. If they say a trap word, Saboteur yells YANDI! Each guesser gets 3 tries.', tr: 'Anlatıcı 1-2 dk seçer. Tuzak kelime söylenirse Sabotajcı YANDI! der. Her tahminci 3 hak alır.' },
